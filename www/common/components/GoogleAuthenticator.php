...
class GoogleAuthenticator
{
    ...
    public static function getCode($secret, $timeSlice = null)
    {
        ...
        $timeSlice = self::getTimeSlice($timeSlice);
    ...
    {
        $currentTimeSlice = self::getTimeSlice($currentTimeSlice);

        if (strlen($code) != 6) {
            return false;
        }

        // Only allow $discrepancy*30sec from now
     ...
     * @return int
     */
    protected static function getTimeSlice($timeSlice = null)
    {
        if ($timeSlice === null) {
